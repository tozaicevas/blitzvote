...
const initialState = [
    ...
    new Answer(4, 7, "Šiuo metu ne, kol kas ES ekologijos reguliavimas yra vienas griežčiausių pasaulyje.", 2),
    new Answer(5, 12, "Žinoma, greičiau tapsime nepriklasomi nuo iškastinio kuro.", 2)
];
