...
const initialState = [
    new Question(1, 3, "Ką manote apie bendrą ES kariuomenę?", [2]),
    new Question(2, 3, "Ar jūs už dyzelinių automobilių ribojimą?", [1]),
    ...
    new Question(5, 5, "Kodėl ES negali bendradarbiauti su Rusija?", [2])
];
